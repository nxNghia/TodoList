...
class SubitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subitem" do
    assert_difference("Subitem.count") do
      post subitems_url, params: { subitem: { content: @subitem.content, root_item: @subitem.root_item } }
    end
  ...
  test "should update subitem" do
    patch subitem_url(@subitem), params: { subitem: { content: @subitem.content, root_item: @subitem.root_item } }
